...
class Dla_Kobiet_Wiadomosci : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dla_kobiet_wiadomosci)
        ...
        newRecyclerView = findViewById(R.id.recycler_view_dla_kobiet_wiadomosci)
    ...
    private fun gerUserdata() {
        ...
        adapter.setOnItemClickListener(object : AdapterDlaKobietSuplementy.OnItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                val intent = Intent(this@Dla_Kobiet_Wiadomosci,MainActivity2::class.java)
