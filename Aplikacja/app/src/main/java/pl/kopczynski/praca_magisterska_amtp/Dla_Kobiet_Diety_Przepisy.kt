...
class Dla_Kobiet_Diety_Przepisy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dla_kobiet_diety_przepisy)
        ...
        newRecyclerView = findViewById(R.id.Recycler_view_dla_kobiet_diety_przepisy)
    ...
    private fun gerUserdata() {
        ...
        adapter.setOnItemClickListener(object : AdapterDlaKobietPrzepis.OnItemClickListener{
            override fun onItemClick(position: Int) {
                if (position == 0 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Makaron w pesto w " +
                            "stylu śródziemnomorskim", Toast.LENGTH_SHORT).show()
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://dieta-sportowca.pl" +
                            "/2022/01/szybkie-przepisy-na-makaron-dla-sportowca/"))
                    startActivity(intent)
                }
                if (position == 1 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Makaron spaghetti z" +
                            " parmezanem w pomidorach", Toast.LENGTH_SHORT).show()
                    val intent = Intent(Intent.ACTION_VIEW,Uri.parse("https://dieta-sportowca.pl" +
                            "/2022/01/szybkie-przepisy-na-makaron-dla-sportowca/"))
                    startActivity(intent)
                }
                if (position == 2 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Makaron z łososiem wędzonym i szpinakiem", Toast.LENGTH_SHORT).show()
                ...
                if (position == 3 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Deser w stylu tiramisu z nieziemsko dobrym makro!", Toast.LENGTH_SHORT).show()
                    val intent = Intent(Intent.ACTION_VIEW,Uri.parse("https://dieta-sportowca.pl/2022/04/domowe-tiramisu/"))
                    startActivity(intent)
                }
                if (position == 4 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Burger z buraka", Toast.LENGTH_SHORT).show()
                ...
                if (position == 5 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Jajecznica", Toast.LENGTH_SHORT).show()
                ...
                if (position == 6 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Owsianka", Toast.LENGTH_SHORT).show()
                ...
                if (position == 7 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy,  "Omlet", Toast.LENGTH_SHORT).show()
                    val intent = Intent(Intent.ACTION_VIEW,Uri.parse("https://dieta-sportowca.pl/2020/09/przepisy-na-szybkie-sniadania-owsianka-i-omlet/"))
                    startActivity(intent)
                }
                if (position == 8 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Skyr waniliowy – kiedy nie ma w sklepie", Toast.LENGTH_SHORT).show()
                ...
                if (position == 9 )
                {
                    Toast.makeText(this@Dla_Kobiet_Diety_Przepisy, "Wytrawna tarta z kurkami", Toast.LENGTH_SHORT).show()
