...
class AdapterDlaKobietWiadomosci(private val exampleList: ArrayList<Wiadomosci>)
    : RecyclerView.Adapter<AdapterDlaKobietWiadomosci.WiadomosciViewHolder>() {
    ...
    fun setOnItemClickListener(listener: AdapterDlaKobietWiadomosci.OnItemClickListener){
        mListener = listener
    }
