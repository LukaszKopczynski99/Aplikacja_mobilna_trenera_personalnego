...
class Kalkulator_zapotrzebowanie_na_wode : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kalkulator_zapotrzebowanie_na_wode)

        EditTextWaga = findViewById(R.id.Waga_kalkulator_zapotrzebowanie_woda)
        ButtonOblicz = findViewById(R.id.Kalkulator_zapotrzebowanie_oblicz_woda)
        TextViewWyswietl_liczba = findViewById(R.id.Kalkulator_zapotrzebowanie_woda_WYNIK_liczba)
