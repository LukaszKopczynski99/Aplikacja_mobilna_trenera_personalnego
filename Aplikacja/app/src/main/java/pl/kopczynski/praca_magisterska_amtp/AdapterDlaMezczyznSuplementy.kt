...
class AdapterDlaMezczyznSuplementy(private val exampleList: ArrayList<Suplementy>)
    : RecyclerView.Adapter<AdapterDlaMezczyznSuplementy.SuplementacjaViewHolder>() {


    private lateinit var mListener: OnItemClickListener

    interface OnItemClickListener : AdapterDlaKobietWiadomosci.OnItemClickListener,
        AdapterDlaMezczyznWiadomosci.OnItemClickListener {
