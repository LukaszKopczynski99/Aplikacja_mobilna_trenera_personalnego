...
class Kalkulator_zapotrzebowanie_kobiety : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kalkulator_zapotrzebowanie_kobiety)

        EditTextWaga = findViewById(R.id.Waga_kalkulator_zapotrzebowanie)
        EditTextWzrost = findViewById(R.id.Wzrost_kalkulator_zapotrzebowanie)
        EditTextWiek = findViewById(R.id.Wiek_kalkulator_zapotrzebowanie)
        ButtonOblicz = findViewById(R.id.Kalkulator_zapotrzebowanie_oblicz)
        TextViewWyswietl_liczba = findViewById(R.id.Kalkulator_zapotrzebowanie_WYNIK_liczba)
        ...
        ButtonOblicz.setOnClickListener(){
            ...
            if(PustePole(Wzrost, Waga, Wiek))
            {
                val zapotrzebowanie = 10 * Waga.toFloat() + 6.25 *
                        Wzrost.toFloat() - 5 * Wiek.toFloat() - 161
    ...
    private fun PustePole(Wzrost:String?,Waga:String?,Wiek:String?):Boolean{
        return when{
            ...
            Wiek.isNullOrEmpty() -> {
                Toast.makeText(this,"Podaj wiek", Toast.LENGTH_SHORT).show()
                return false
            }
            else -> {
                return true
