...
class Dla_Kobiet_Kalkulatory : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_dla_kobiet_kalkulatory)

        calc_zapotrzebowanie = findViewById(R.id.button_dla_kobiet_kalk_zapotrzebowanie)
        calc_BMI = findViewById(R.id.button_dla_kobiet_kalk_BMI)
        calc_woda = findViewById(R.id.button_dla_kobiet_kalk_woda)
        ...
        calc_zapotrzebowanie.setOnClickListener(){
            ...
            val intent = Intent(applicationContext,Kalkulator_zapotrzebowanie_kobiety::class.java)
        ...
        calc_woda.setOnClickListener(){
            ...
            val intent = Intent(applicationContext,Kalkulator_zapotrzebowanie_na_wode::class.java)
            startActivity(intent)
        }
